...
<template>
<!-- we get the product data from the data store in the created hook in our code -->
<!-- product is the name we used to hold/reference the product data in the hook  -->
<div id='app' class='main'>
    <h1>{{ product.name }}</h1>  <!-- get the name for the product selected-->
    <p class='description'>{{product.description}}</p>
    <div class="actions">
        <!-- Define a link back to products home page                               -->
        <!-- v-bind:to="/" would work too, but use of named paths is preferred      -->
...
export default {
    ...
    created() {  // Define code to be run for the created hook in Vue processing
