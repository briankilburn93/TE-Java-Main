...
public class AmericanPlayingCard extends PlayingCard{
	 ...
	 * 		The data in the Maps will be the same for all instances of objects and doesn't change
	 *************************************************************************************************/	
	 ...
	 *
	 *We need to define an anonymous static method to run the initialMaps method
	...
	public AmericanPlayingCard() // subclass, default ctor
	{
		...
		//The keyword super is used to reference the super class
	 ...
	 * 
	 * Note: static for a method means there is only one regardless of the number of instantiated objects
	 * 		it can only change static data members
	 * 		the Maps are defined as static for the Class
	 ***************************************************************************************************/	
	private static void initializeMaps() {
		
		//suitMap contains valid suits and their associated colors
		//	if the user gives us a suit that's not in the Map, we know it's an invalid suit
		suitMap.put("SPADES"  , "BLACK");
		suitMap.put("CLUBS"   , "BLACK");
		suitMap.put("DIAMONDS", "RED");
		suitMap.put("HEARTS"  , "RED");
		
		//valueMap - associates a word to values of the cards
	 ...
	 *                            to present the values of an AmericaPlayingCard as a String
	 ***************************************************************************************/
