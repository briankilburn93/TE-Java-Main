...
public class Exercises {
	...
	public int[] rotateLeft3(int[] nums) {
		int[] rotateToLeft = new int[3];
		rotateToLeft[0] = nums[1];
		rotateToLeft[1] = nums[2];
		rotateToLeft[2] = nums[0];
	...
	public int[] reverse3(int[] nums) {
		int[] reverseOrder = new int[3];
		reverseOrder[0] = nums[2];
		reverseOrder[1] = nums[1];
		reverseOrder[2] = nums[0];
