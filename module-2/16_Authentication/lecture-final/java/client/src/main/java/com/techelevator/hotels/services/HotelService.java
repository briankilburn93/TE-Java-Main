...
public class HotelService {
  ...
  private HttpEntity<Reservation> makeReservationEntity(Reservation reservation) {
    ...
    headers.setBearerAuth(AUTH_TOKEN);          // Include JWT with the header for making a reservation
  ...
  private HttpEntity makeAuthEntity() {     // Create an authorization header for request
    ...
    headers.setBearerAuth(AUTH_TOKEN);             // Set the BearerToken in the header to the JWT
                                                   // We got from the app at login
    HttpEntity entity = new HttpEntity<>(headers); // Create an HTTP Entity to be included 
                                                   //    in the request
