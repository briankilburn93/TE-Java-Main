...
// Instantiate Service objects to handle console and Hotel interactions  
        ...
        HotelService   hotelService   = new HotelService(API_BASE_URL);  // Instantiate HotelService with this URL
        ...
        consoleService.exit();  // Asking the consoleService to do what does on exit 
    }
