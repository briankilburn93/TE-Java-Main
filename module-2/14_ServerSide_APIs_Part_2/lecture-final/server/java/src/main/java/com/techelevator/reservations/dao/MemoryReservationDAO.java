...
public class MemoryReservationDAO implements ReservationDAO {
    ...
    private HotelDAO hotelDAO;  // Define a reference to teh DAO we are using to access data

    // The ctor for this class needs a HotelDAO object to work - passed as a parameter
