...
SELECT name, continent, population, lifeexpectancy FROM country WHERE lifeexpectancy > 80;
...
SELECT name, region FROM country WHERE continent='North America' AND region!='Caribbean' OR continent='South America' AND region!='Caribbean';
...
SELECT name, (2020 - indepyear) AS years_since_independence FROM country WHERE indepyear IS NOT NULL;